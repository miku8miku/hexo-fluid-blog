...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135974.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201123414.webp)

板号的丝印是: UFI103S_V05，UFI 开头的，基本确定就是高通的芯片。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135477.webp)

如果你感兴趣，背面的屏蔽罩，可以用小刀撬开，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201123335.webp)

正面的贴纸也可以撕开，可以看到具体的芯片型号。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136163.webp)

# **切卡**

好了，我们首先插入自己的 SIM 卡，它这个需要插入大卡。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135553.webp)

注意 SIM 卡的方向，不要插反了。

然后把随身 WiFi 插入电脑，电脑浏览器登录后台，可以在「高级设置 - SIM 卡」中进行切卡操作。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135484.webp)

这里切卡不需要密码，默认是 sim2，我们把它切换到 sim1。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201123111.webp)

如果你的设备切卡需要密码，可以使用 adb 命令获取到密码，也可以在备份系统时自己查看甚至修改密码，具体操作后面我会讲到。

切卡完成后可以看到，SIM 卡的信息变成了自己的卡（IMSI、ICCID），顶部的网络状态也可用了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136714.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135289.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135385.webp)

驱动安装完成以后。一般情况下，可以在按住 reset 复位键的同时，把随身 WiFi 插入电脑。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135639.webp)

这时候在电脑的「设备管理器 - 端口」下，就会出现一个 9008 的设备。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201123410.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135918.webp)

随后设备就会重启，自动进入 9008 模式。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135057.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135819.webp)

安装位置根据自己的情况来选择，我这里就是默认一直下一步，安装完成以后，我们需要来到软件的安装目录。

可以直接在桌面快捷方式上右键，选择「属性」

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201123685.webp)

点击「打开文件所在位置」，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135492.webp)

然后把 Loader.exe 移动到安装目录，以后只需要运行这个启动器就可以了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135562.webp)

为了方便，可以右键把它发送到桌面，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135420.webp)

然后重命名为 miko。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135168.webp)

双击 miko 运行它。

我们的目的是备份整个固件，依次选择「Read - Partition Backup/Erase」。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135382.webp)

然后点击「Load Partition Structure」，来加载随身 WiFi 的固件内容。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135026.webp)

这里需要等待一会，可以在右边的窗口查看现在的状态。

当显示「SUCCESS」、固件的大小以及所用的时间，就表示读取成功了，软件中间也会显示了读取到的所有分区。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135494.webp)

然后我们全选所有分区，点击「Read Full Image」，选择备份文件的保存位置和文件名，这时候软件下方就会出现一个进度条。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135820.webp)

当进度条达到 100%，然后稍等一会，等右边的状态窗口显示「SUCCESS」、以及所用时间后就表示备份完成了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135507.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135181.webp)

文件大小一样，用压缩软件 7-zip 打开查看，里面包含的内容也都是一样的。

大家选择默认的就可以了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124857.webp)

# **Miko：备份恢复**

再来顺便说一下恢复的操作，依次选择「Flash - emmc block0 flasher」，双击选择备份文件，然后点击「FLASH！」，就可以完整恢复了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135679.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135453.webp)

并且我们需要手动对它进行激活，在 QPT 目录中有一个 KEYGEN 程序。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135201.webp)

执行后可能需要安装「.NET Framework 3.5」，直接点击下载并安装就可以了。

安装完成以后，继续执行 KEYGEN 程序，点击「GenerateKey」生成一个 key 文件，取个名字后保存在任意位置。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136822.webp)

然后打开 QPT 软件，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135927.webp)

点击左上角的「Help - Activate」，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124437.webp)

选择刚刚生成的 key 文件，这样就激活成功了，激活后软件右下角会显示：Activated。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124769.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135353.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135522.webp)

现在就可以在列表中，选择我们需要备份的分区了。

比如这里选择 1 号 modem 分区，点击「Do Job」，选择文件的保存位置后，就开始备份了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135571.webp)

同样的，通过观察左侧 Log 窗口与左下角的信息，就可以确定现在的状态。

用相同的操作，依次备份一下：modem，modemst1，modemst2，fsg 分区。其中「modem 分区」生成的备份文件名为「NON-HLOS.bin」。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135024.webp)

当然了，在 QPT 中我们也可以一键备份所有的分区。

具体的操作，就是在读取到所有分区的信息后，不去选择具体的某一个分区，而是直接勾选右侧的「Backup All」，然后直接「Do Job」执行，这时候它就会把所有的分区都备份下来。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135952.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135128.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135559.webp)

但是备份和恢复 QCN 文件，设备必须要有超级用户权限，也就是 root 权限，所有我们首先需要 root 随身WiFi。

这里我们需要用到安卓远程桌面软件 ARDC，解压后即可直接使用。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135390.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124463.webp)

当成功连接后就会显示这个设置页面，跟安卓手机一样，可用直接在其中查看设备的各种信息。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135947.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135916.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135828.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135852.webp)

然后打开 Magisk 应用，当前的状态是：无法获取。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135067.webp)

点击「安装 - 下一步 - 方式：选择并修补一个文件」，在跳出的路径中选择「Download」，选中刚才上传的「boot.img」，选择「标准安卓方式」，然后「开始」，当显示「完成！」后，可以看到修补后的 img 文件，也被保存在了 Download 文件夹中。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136649.webp)

鼠标右键返回到桌面，然后打开「ES文件管理器」，来到 「下载」也就是「Download」目录中，长按鼠标左键选中修补后的 img 文件，选择下方的 「重命名」操作，取一个方便一些的名称。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135758.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135807.webp)

传输完成后，就可以在 ARDC 的目录中找到「magiskboot.img」。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136777.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135864.webp)

然后「fastboot flash boot magiskboot.img」。写入完成后，使用「fastboot reboot」重启设备。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124533.webp)

最后还是来到 ARDC ，打开 Magisk 应用，可以看到当前的 Migisk 版本号，并且最下面显示了这个按钮浮窗，就表示设备已经 root 成功了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135444.webp)

为了后续 QCN 的顺利备份，我们首先要给命令行 shell 授予 root 权限。

在 CMD 中输入「adb shell su」，回车后 ARDC 中会显示超级用户请求弹窗，只需要在倒计时结束前点击「允许」即可。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136898.webp)

如果错过了，也可以在 Magisk 中，来到下方的「盾牌」页面，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135884.webp)

重新给 Shell 授权超级用户权限。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124715.webp)

# **QPST：QCN 备份**

好了，下面就进行 QCN 的备份，可以使用 QPST 软件。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135748.webp)

解压后进行安装，安装完成后在开始菜单选择 「QFIL」打开。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135224.webp)

这里需要连接设备的 901D 端口，所以我们要在命令行中输入「adb shell su」、「setprop sys.usb.config diag,adb」。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135137.webp)

执行后查看设备管理器，就会在端口中看到 901D 设备。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135256.webp)

然后在 QFIL 中点击「SelectPort」，选择识别到的设备。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135541.webp)

选择「Tools - QCN Backup Restore」，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136867.webp)

这里需要选择备份文件，我们可以提前创建一个空的「.qcn」文件，然后在「QCN Backup Restore」中选择它，点击「Backup QCN」，就开始备份了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201124212.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201136299.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201135958.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125200.webp)

而其中大部分信息，也都是通过「getprop」命令获取到的。

通过「adb shell」进入设备命令行，然后输入「getprop」命令可以看到会有很多属性。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201131806.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201132223.webp)

而使用「grep ufi」，就会展示随身 WiFi 的各种配置信息，比如设备的切卡密码、后台登录密码等。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125942.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201132350.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125866.webp)

使用「ls -l」命令，可以看到对于一般用户「build.prop」文件的权限是只读，只有 root 用户才有写权限。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125988.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125971.webp)

如果你的设备没有开启 adb，就在最后添加「, adb」即可。

同样的操作把三个「build.prop」文件都修改了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125361.webp)

然后打开「DiskGenius」软件，把「system.img」镜像文件拖进去，选中「镜像分区」，切换到「浏览文件」，然后依次把刚才修改过的「build.prop」文件，拖到对应的位置，直接替换即可。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133529.webp)

替换完成后，把设备进入 9008 模式，用 QPT 软件恢复 system 分区，恢复完成后重新插拔随身 WiFi，重启后 adb 就会打开了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125612.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133736.webp)

而且大部分设备默认是开启 adb 的，就可以直接使用「adb reboot bootloader」进入 fastboot 模式。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201125643.webp)

然后用「fastboot flash system system.img」，刷入修改后的 system 分区。

刷写完成后 fastboot reboot 重启就可以了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126052.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126619.webp)

选择之前备份的 qcn 文件打开，就会在左侧窗口看到设备的串号。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126552.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133775.webp)

然后就是恢复 qcn 的操作。

上一篇文章已经提到过，就是先执行「高通强开 1 - 写入 QCN - 一键执行」，等待 QCN 导入完成就可以了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133869.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126582.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126532.webp)

我这里还尝试了直接将修改后的 build.prop 文件，push 到随身 WiFi 中，

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126114.webp)

然后 su 切换到 root 用户，使用 cp 命令把修改后的 build.prop 文件，直接复制到 system 文件夹中替换。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126395.webp)

用 cat 命令查看确实已经修改了。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133998.webp)

然后 adb reboot 重启设备，也可以达到同样的效果。

最后成功修改了 IMEI 串号，随身 WiFi 也能正常使用。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126386.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133459.webp)

首先来到「发送通道」，点击右上角的「+」号。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126212.webp)

选择一个转发短信的途径，我这里选择的是电子邮箱，其它的大家可以自行尝试。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133478.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126631.webp)

发件人昵称随便填写，收件地址就是接收信息的邮件地址，可以跟发件邮箱是同一个（自己给自己发），还可以同时填写多个邮箱地址，邮件主题可以直接从下面选择标签。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133441.webp)

填写完成后点击「测试」。只要账号和密码都填写正确，这时候你的收件邮箱就会收到一条测试邮件。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201133129.webp)

保存后来到「转发规则」，同样是点击右上角的「+」号。

![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126126.webp)
...
![img](https://fastly.jsdelivr.net/gh/miku8miku/images@main//202510201126541.webp)
