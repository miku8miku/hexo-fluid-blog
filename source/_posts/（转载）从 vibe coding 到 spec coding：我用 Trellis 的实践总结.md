---
title: （转载）从 vibe coding 到 spec coding：我用 Trellis 的实践总结
date: 2026-7-13 12:00:00
tags:
  - Trellis
  - AI编码
  - spec coding
...
categories:
  - AI开发
  - 工程实践
index_img: https://r2.miku2024.top/r2/2026/07/2da74ac37aa948495ace246cac3391ee.png
copyright: true
source: https://linux.do/t/topic/2151853
---
...
![img](https://r2.miku2024.top/r2/2026/07/2631e868fd684fb3ba51d50ca9ea3753.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/33a25e975ce5e5c74753f15772d952b5.jpeg)
...
> 其实trellis 的价值就是把这些问题从只靠用户不断提醒，去变成项目结构里本来就有的工程。

> 当然，trellis 也不是完美方案。它需要前期投入、需要维护习惯、也有学习成本的。如果我们的项目已经到了 vibe coding 撑不住的阶段，需要一个更稳定的 ai 协作方式的话，trellis 就是目前比较完整的一个尝试。



![img](https://r2.miku2024.top/r2/2026/07/987a7cb3cade7387eb5d18b85a66799b.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/632655741746a1ea687ad14e8939e8c0.png)



![img](https://r2.miku2024.top/r2/2026/07/63a3b49a7ae5a248c017592fd86f0270.png)



![img](https://r2.miku2024.top/r2/2026/07/f5f07ae4c5b933389cf072cc3c95e8bf.png)
...
![img](https://r2.miku2024.top/r2/2026/07/1639a26c85eaaa1fe067d8ee20d03ee1.png)
...
> 有 sessionstart hook、plugin 或 extension 的平台，打开终端后通常会自动注入这份紧凑上下文，所以我们直接描述任务就行。怀疑上下文 没加载时，可以新开一个会话，或者让 ai 读一次 `trellis-start` skill。这类平台通常没有用户可见的 `/trellis:start`，因为启动路径已经负责 orient了。

**但是如果我们使用 codex 进行开发的时候还不太一样。**

> 因为它主要靠仓库根目录的 `AGENTS.md` 做 prelude， 再通过 `UserPromptSubmit` hook 注入 workflow-state的，新版本 codex cli 里 hooks 可能已经默认开启了。但如果 / 菜单里看不到 trellis 的 command / skill，或者 workflow 指引没有自动注入，我们可以通过检查 ~/.codex/config.toml 里是否开启了 features.hooks = true。 并通过 /hooks 审批 trellis 安装的 hook。即便 hook 没跑起来，trellis 仍然可以通过 AGENTS.md fallback 让 ai 读取 trellis-start，只是体验会弱一些。
...
![img](https://r2.miku2024.top/r2/2026/07/8dc1396727652b8a41e80e2d44b7b9b9.png)
...
![img](https://r2.miku2024.top/r2/2026/07/68dcb9cfd570eea9223266ecc3d7040a.png)
...
![img](https://r2.miku2024.top/r2/2026/07/e8870c09c094e89a5981745bf5a6adca.png)
...
![img](https://r2.miku2024.top/r2/2026/07/11b979fa06774c09b6a1d0d98421dffc.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/2799d2a29d32fa7b3b523b32598cce31.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/c6df81427913a622bdcf881075d7c309.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/7f7f56e13e66c504c4858c91771eec16.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/60721ae3b90083a812d9d661af56d59d.jpeg)
...
![img](https://r2.miku2024.top/r2/2026/07/d4e7370a23a7abb057bb2b84294a875b.jpeg)
